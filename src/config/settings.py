...
class AppSettings(BaseSettings):
    ...
    azure_openai_endpoint: Optional[AnyHttpUrl] = Field(
    ...
    openai_model: str = Field(
        default="gpt-5", description="Default OpenAI chat model name"
    )
    ...
    pii_redaction_enabled: bool = Field(default=True, description="Redact PII in preprocess pipeline")
    ...
    @classmethod
    def warn_plaintext_secrets(cls, v: Optional[str]) -> Optional[str]:
